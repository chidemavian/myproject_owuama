...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'geo_settlement', 's',
                      self.gf('django.db.models.fields.DecimalField')(default='23.3', max_digits=15, decimal_places=2),
                      keep_default=False)
    ...
    models = {
        u'geo.settlement': {
            ...
            's': ('django.db.models.fields.DecimalField', [], {'max_digits': '15', 'decimal_places': '2'}),
