...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'tblsettlement'
        db.create_table(u'geo_tblsettlement', (
        ...
        db.send_create_signal(u'geo', ['tblsettlement'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'tblsettlement'
        db.delete_table(u'geo_tblsettlement')
    ...
    models = {
        ...
        u'geo.tblsettlement': {
            'Meta': {'object_name': 'tblsettlement'},
